...
train, test = train_test_split(dfnew, test_size=0.2, random_state=101, stratify=dfnew['labels'])
	...
	"bert", 
        "bert-base-multilingual-uncased",  
         ...
         args={"num_train_epochs": 1, "train_batch_size": 16, "overwrite_output_dir": True,  "learning_rate": 1e-5,
          "max_seq_length": 256, "save_eval_checkpoints": False, "save_model_every_epoch": False, "output_dir": "out3/"}
)
...
myfile = open('fscore_m-bert_1eminus5_256_35.txt', 'w')
...
for epoch in range(35):
 ...
 #   result, model_outputs, wrong_predictions = model.eval_model(test)
    ...
    myfile.write("This is the output m-bert \n")
